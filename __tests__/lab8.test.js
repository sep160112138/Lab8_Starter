describe('Basic user flow for Website', () => {
  ...
  beforeAll(async () => {
    await page.goto('https://cse110-f2021.github.io/Lab8_Website' /*'http://127.0.0.1:5500/index.html'*/);
  });
  ...
  it('Checking number of items in cart on screen', async () => {
    ...
    let cartCountInner = await cartCount.getProperty('innerText');
    let value = await cartCountInner.jsonValue();
  ...
  it('Checking number of items in cart on screen after reload', async () => {
    ...
    for (let i = 0; i < prodItems.length; i++) {
      shadowRoot = await prodItems[i].getProperty('shadowRoot');
      btn = await shadowRoot.$('button');
      btnInner = await btn.getProperty('innerText');
      let value = await btnInner.jsonValue();
    ...
    let cartCount = await page.$('#cart-count');
    let cartCountInner = await cartCount.getProperty('innerText');
    let cartValue = await cartCountInner.jsonValue();
